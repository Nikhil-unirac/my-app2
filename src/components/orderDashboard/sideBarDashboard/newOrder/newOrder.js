...
import Sidebar from '../../../orderDashboard/sideBarDashboard/newOrder/sidebarNO/sidebarNO'; 
...
const Dashboard = () => {
  ...
  const handleButtonClick = (index) => {
    ...
    updatedRows[index].buttonLabel = 'New order';
